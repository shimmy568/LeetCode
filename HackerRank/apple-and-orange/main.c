...
int getFruitCount(int s, int t, int a, int fruit_count, int *fruits)
{
    int count = 0;
    for (int i = 0; i < fruit_count; i++)
    {
        int fruitPos = fruits[i] + a;
        // printf("%d, %d, %d\n", fruitPos, s, t);
...
{
    printf("%d\n", getFruitCount(s, t, a, apples_count, apples));
    printf("%d\n", getFruitCount(s, t, b, oranges_count, oranges));
}
